...
import { Container, Stepper, Step, StepLabel, Button, TextField, Typography, Table, TableBody, TableCell, TableContainer, TableRow, Paper, Grid, Box, Select,
InputLabel,
MenuItem,
Card,
CardContent,
        ...
        <Grid container spacing={2} marginTop={2}>
            <Grid item xs={12} md={6} position={'relative'} marginLeft={30} >
                <Card sx={{
                    ...
                    boxShadow: 3,    
                   // marginLeft:15,            // Optional: adds shadow for 3D effect
                }}>
                    <CardContent>
            ...
            <Card sx={{
                    ...
                    boxShadow: 3,  
                    width: 350,
                    // marginLeft:1,              // Optional: adds shadow for 3D effect
                }}>
                    <CardContent>
                    <Box
            sx={{
...
function getSteps() {
    return ['Basic Information', 'Course Details', 'Fees and Links'];
}
